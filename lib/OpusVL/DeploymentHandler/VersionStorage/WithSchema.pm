use strict;
use warnings;
package OpusVL::DeploymentHandler::VersionStorage::WithSchema;

# ABSTRACT: Version storage for DeploymentHandler that includes the schema

use Moose;
use DBIx::Class::DeploymentHandler::LogImporter ':log';
use OpusVL::DeploymentHandler::VersionStorage::WithSchema::VersionResult;
our $VERSION = '0.002';
...
sub _build_version_rs {
  $_[0]->schema->register_class(
    __VERSION =>
      'OpusVL::DeploymentHandler::VersionStorage::WithSchema::VersionResult'
  );
